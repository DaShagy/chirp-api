package com.juanjoseabuin.chirp.infra.storage

import com.fasterxml.jackson.annotation.JsonProperty
import com.juanjoseabuin.chirp.domain.exception.InvalidProfilePictureException
import com.juanjoseabuin.chirp.domain.exception.StorageException
...
class SupabaseStorageService(
    ...
    companion object {
        private val allowedMimeTypes = mapOf<String, String>(
            "image/jpeg" to "jpg",
            "image/jpg" to "jpg",
            "image/png" to "png",
            "image/webp" to "webp"
