package com.juanjoseabuin.chirp.infra.push_notification
...
import com.juanjoseabuin.chirp.domain.model.PushNotificationSendResult
                    ...
                    when(recipient.platform) {
                        DeviceToken.Platform.ANDROID -> setAndroidConfig(
                            AndroidConfig.builder()
                                ...
                                .setRestrictedPackageName("com.juanjoseabuin.chirp")
                                .build()
                        )
